...
main() {
    ...
    artifact_name="argiope-${platform}.tar.gz"
    ...
    install -m 755 "${tmp_dir}/argiope" "$INSTALL_DIR/argiope"

    echo "argiope installed to ${INSTALL_DIR}/argiope"
}
